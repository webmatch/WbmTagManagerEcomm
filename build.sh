...
zip -r WbmTagManagerEcomm-${commit}.zip WbmTagManagerEcomm -x WbmTagManagerEcomm/bin/\* WbmTagManagerEcomm/.travis.yml WbmTagManagerEcomm/build.sh WbmTagManagerEcomm/.eslintignore WbmTagManagerEcomm/phpstan.neon WbmTagManagerEcomm/phpstan.neon.dist WbmTagManagerEcomm/psalm.xml WbmTagManagerEcomm/.gitignore WbmTagManagerEcomm/.git/\* WbmTagManagerEcomm/.github/\*
