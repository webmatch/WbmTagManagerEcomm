...
use Wbm\TagManagerEcomm\WbmTagManagerEcomm;
...
$pluginWbmTagManagerEcomm = [
    'autoload' => $composerJson['autoload'],
    'baseClass' => WbmTagManagerEcomm::class,
    'managedByComposer' => false,
    'active' => true,
    'path' => $pluginRootPath,
];
$pluginLoader = new StaticKernelPluginLoader($classLoader, null, [$pluginWbmTagManagerEcomm]);
